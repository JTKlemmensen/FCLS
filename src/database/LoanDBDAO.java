...
public class LoanDBDAO implements LoanDAO
{
	public Boolean insertLoanAgreementDB(LoanAgreementDataModel loanAgreement)
	{
		...
		try
		{
			...
			statement =con.prepareStatement("INSERT INTO LoanAgreement_table "+
			"( customer, salesPerson, car, loanStartDate, loanDuration, askingPrice, rate, approved, downPayment)"+
			" VALUES(?,?,?,?,?,?,?,?,?)");
