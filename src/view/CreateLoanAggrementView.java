...
public class CreateLoanAggrementView implements View
{
	...
	public boolean onClose()
	{
		...
		Alert alert = new FCLSAlert(AlertType.NONE,"Vil du anullere oprettelsen af L�neaftalen?",ButtonType.OK,new ButtonType("Anuller",ButtonData.CANCEL_CLOSE));
		alert.setTitle("Bekr�ft Afslutning");
		alert.showAndWait();
