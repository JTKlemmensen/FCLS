...
public class TestCarDataModel {
	...
	CarDataModel car = new CarDataModel(null, null, null);
	@Test
	public void testVIN() {
		car.setVIN("bob");
	...
	public void testStartPrice() {
		...
		CarDataModel car = new CarDataModel(null, startPrice, null);
		assertEquals(startPrice, car.getStartPrice());
	}
	@Test
	public void testStartPrice2() {
		BigDecimal startPrice = new BigDecimal(200);
		CarDataModel car = new CarDataModel(null, startPrice, null);
		assertEquals(startPrice, car.getStartPrice());
	}
